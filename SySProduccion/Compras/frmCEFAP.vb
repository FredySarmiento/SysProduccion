...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmCEFAP_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        Catch ex As Exception
            MsgBox("Error :  frmCEFAP_Disposed")
            MsgBox(ex.Message)
        End Try

    End Sub

    Private Sub frmCEFAP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
            ...
            If wg_sFrmOri = "frmCEODC" Then
                ...
                dgv_wp_aeGLMOV1ADgv()
            End If
            If wg_sFrmOri = "frmCEENI" Then
                BD_Var_wp_aeGEMOV()
                BD_eGEMOV_Var()
                dgv_wp_aeGLMOV1ADgv()
            End If
        Catch ex As Exception
            MsgBox("Error :  frmCEFAP_Load")
            MsgBox(ex.Message)
        End Try
    End Sub
        ...
        Try
            ...
            If lstCpa.SelectedIndex = 0 Then
                If wl_eGEMOV.sTipDoc <> "IT" Then
                    ...
                    cmdCpa.Focus()
                Else
                    Dim wl_frmGEMOV As New frmCEODC
                    Dim wl_sFrmDtn As New frmCEODC
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_frmLstdet()
        Try
            ...
            wg_sTitCon11 = "Código Fac"
            wg_sTitCon12 = "Número Fac"
            wr_bEOFCon1 = True
...
#Region "082 Pep Procedimientos eventos personalizados"
    ...
    Private Sub txtnNroDoc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnNroDoc.DoubleClick
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "CEFAP"
            wl_frmLst.wp_sTxtFrm = "Consulta consecutivo facturas de proveedores"
