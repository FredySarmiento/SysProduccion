...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmCENOC_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        grl_RemoveHandler()
        Me.Dispose()
    End Sub

    Private Sub frmCENOC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text += "  -  " + vg_sNomCia
        grl_RemoveHandler()
        grl_AddHandler()
        mof_fCnfCtrl(Me)
            ...
            For wl_nRow = 0 To wl_CtrlDgv.RowCount - 1
                ...
                Else
                    If wp_sCmdSel = "A" Then
                        wl_eGLMOV1.sCodDoc = wl_CtrlDgv.Rows(wl_nRow).Cells("sCodDoc").Value
                        wl_eGLMOV1.nNroDoc = wl_CtrlDgv.Rows(wl_nRow).Cells("nNroDoc").Value
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_frmLstdet()
        Try
            ...
            wg_sTitCon11 = "Código NC"
            wg_sTitCon12 = "Número NC"
            wr_bEOFCon1 = True
...
#Region "082 Pep PROCEDIMIENTOS EVENTOS PERSONALIZADOS"
    Private Sub txtnNroDoc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnNroDoc.DoubleClick
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "CENOC"
            wl_frmLst.wp_sTxtFrm = "Consulta consecutivo notas crédito"
