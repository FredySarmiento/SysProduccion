...
#Region "020 frm Eventos - Principal"
    Private Sub frmCENOD_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        grl_RemoveHandler()
        Me.Dispose()
    End Sub

    Private Sub frmCENOD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text += "  -  " + vg_sNomCia
        grl_RemoveHandler()
        grl_AddHandler()
        mof_fCnfCtrl(Me)
