...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmCESAI_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        ...
        Catch ex As Exception
            MsgBox("Error :  frmCESAI_Disposed")
            MsgBox(ex.Message)
        End Try
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    ...
    End Sub
    Private Sub cmdLstCESAI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLstCESAI.Click
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "CESAI"
            wl_eGEMOV = New moe_Estructuras.eGEMOV
            ...
            End If
        Catch ex As Exception
            MsgBox("Error : cmdLstCESAI_Click")
            MsgBox(ex.Message)
        End Try
    End Sub
#End Region
...
#Region "090 Rpt - Reportes"
    Private Sub Rpt_PrmRpt()
            ...
            mof_ActivarOK(Me)
            Dim wl_frmRPT As New rptCRSAI01
