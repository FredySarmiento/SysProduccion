...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmCESAI_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        grl_RemoveHandler()
        Me.Dispose()
    End Sub
    Private Sub frmCESAI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grl_RemoveHandler()
        grl_AddHandler()
        mof_fCnfCtrl(Me)
        mof_IniciarVar()
    ...
    Private Sub Cbo_CargarAPLND1()
        Try
            ...
            If Not wr_bEOFLst1 Then
                ...
                cboAPLND1.SelectedValue = wg_DTE2.Rows(0).Item(1)
            End If
        Catch ex As Exception
        ...
        Try
            ...
            For wl_nRow = 0 To wl_CtrlDgv.RowCount - 1
                ...
                If wl_eGEMOV.sTipDoc = "IT" Then
                    If wl_CtrlDgv.Rows(wl_nRow).Cells(6).Value Is Nothing Then
                        Exit For
                    End If
                End If
                If wl_eGEMOV.sTipDoc = "SE" Then
                    If wl_CtrlDgv.Rows(wl_nRow).Cells(7).Value Is Nothing Then
                        Exit For
                    End If
                End If
    ...
    Private Sub dgv_AdiRow()
        ...
        Try
            With wl_CtrlDgv
                ...
                .CurrentRow.Cells(1).Value = wl_eGEMOV.sCodDoc
                .CurrentRow.Cells(2).Value = wl_eGEMOV.nNroDoc
                .CurrentRow.Cells(3).Value = wl_eGEMOV.sTipMov
                .CurrentRow.Cells(35).Value = cboAPLND1.Text
                .CurrentRow.Cells(36).Value = wl_eGEMOV.sClsDoc
        ...
        Try
            ...
            If wg_aeAPDGV(wl_nColAnt).sNomCmp = "nCanItm" Or
                ...
                mof_fGLMOV1TotLin(wl_eGLMOV1.nCanItm,
                                ...
                                wl_eGLMOV1.nTotLin)
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(12).Value = wl_eGLMOV1.nPreUni
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(13).Value = wl_eGLMOV1.nVlrBas
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(15).Value = wl_eGLMOV1.nVlrDto
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(16).Value = wl_eGLMOV1.nPreDto
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(17).Value = wl_eGLMOV1.nVlrDtoLin
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(20).Value = wl_eGLMOV1.nVlrIva
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(21).Value = wl_eGLMOV1.nVlrIvaLin
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(22).Value = wl_eGLMOV1.nPreBru
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(23).Value = wl_eGLMOV1.nTotLin
                wl_CtrlDgv.Rows(wl_nRowKU).Cells(39).Value = wl_eGLMOV1.nVlrBasUsd
...
#Region "082 Pep PROCEDIMIENTOS EVENTOS PERSONALIZADOS"
    ...
    Private Sub txtnNroDoc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnNroDoc.DoubleClick
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "IEMOV"
            wl_frmLst.wp_sTxtFrm = "Consulta consecutivo salidas de compra"
