...
#Region "015 Estructuras"
    ...
    Dim wl_aeATUSR() As moe_Estructuras.eATUSR
...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmATPUS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "043 BD Cargar"
    Private Sub BD_CargarATAUT()
        Try

            Dim wl_frmLst As New frmATAUTLst
            wl_eATAUT = New moe_Estructuras.eATAUT
            wl_frmLst.wp_eATAUT = New moe_Estructuras.eATAUT
            wl_nRow = wl_CtrlDgv.CurrentCellAddress.Y
            wl_nCol = wl_CtrlDgv.CurrentCellAddress.X

            wl_frmLst.vp_sCodUsr = wl_CtrlDgv.CurrentRow.Cells("sCodUsr").Value
        ...
        Catch ex As Exception
            MsgBox(ex.Message)
            MsgBox("Error en el SUB: BD_CargarATAUT")
        End Try
    End Sub
#End Region
#End Region
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    ...
    Private Sub dgv_DetADgv()
        ...
        wl_CtrlDgv = Me.dgv1
        Try
            wl_DTL1 = clnTblAB.cndtCrgATUSR(wl_bEOF)
