...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    'Estructuras
    Public Property wp_eATAUT As moe_Estructuras.eATAUT
    'variables
    Public Property vp_sCodUsr As String
...
#Region "014 Objetos locales"
    Dim clnAPQDG As New ClaseNegocios.clnAPQDG
...
#Region "015 Estructuras"
    ...
    Dim wl_aeATAUT() As moe_Estructuras.eATAUT
...
#Region "020 frm Eventos - Principal"
    Private Sub frmATAUTLst_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "050 CommandButtons_Click ABRECO Controladores de Eventos (Remitente_evento)"
    Private Sub cmdActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdActualizar.Click
        ...
        If wl_bYesNo Then
            wl_bYesNo = dgv_ActDetATAUT(wp_sCmdSel)
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    Private Function dgv_ActDetATAUT(ByVal wp_sCmdSel As String) As Boolean
        Dim wl_nRow As Integer
        ...
        Try
            ...
            For wl_nRow = 0 To dgv1.RowCount - 1
                ...
                moo_eATAUT_DGV(wl_eATAUT,
                               Me.dgv1,
                               wl_nRow)
                '                  
                If wl_eATAUT.nID <> 0 Then
                    wp_sCmdSel = "A"
                Else
                    wp_sCmdSel = "C"
                End If
                If dgv1.Rows(wl_nRow).Visible = True Then
                    wl_bYesNo = clnATAUT.cnCrearActATAUT(wl_eATAUT,
                                                         wr_bEOFL1,
                                                         wp_sCmdSel)
                Else
                    If wp_sCmdSel = "A" Then
                        '  wl_bYesNo = clnATAUT.cnEliATAUT(wl_eATAUT,
                        '                                 wr_bEOFL1)
                    End If
                End If
    ...
    Private Sub dgv_DetADgv()
        ...
        wl_eATAUT.sCodUsr = vp_sCodUsr

        Try
            wl_DTL1 = clnATAUT.cndtConATAUT(vp_sCodUsr,
                                            wl_bEOF)
            ...
            If Not wr_bEOFL1 Then
                With wl_CtrlDgv
                    For wl_nRow = 0 To wl_DTL1.Rows.Count - 1
                        dgv_AdiRow()
                        wl_eATAUT = New moe_Estructuras.eATAUT
                        moo_eATAUTLst_DT(wl_eATAUT,
                                      wl_DTL1,
                                      wl_nRow)
                        moo_DGV_eATAUTLst(wl_CtrlDgv,
                                         wl_eATAUT,
                                         wl_nRow)
                    Next
                End With
