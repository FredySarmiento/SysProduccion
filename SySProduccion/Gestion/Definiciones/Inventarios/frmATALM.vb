...
#Region "012 BD - Variables campos BD Locales"
    ...
    Dim vl_sNomAlm As String
    Dim vl_sUbiAlm As String
...
#Region "014 Objetos locales"
    Dim clnATALM As New ClaseNegocios.clnATALM
...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmATALM_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
        Catch ex As Exception
            MsgBox("Error : frmATALM_Disposed")
            MsgBox(ex.Message)
        End Try
    End Sub

    Private Sub frmATALM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
...
#Region "040 BD Procedimientos sobre la BD. Personalizados"
    Private Function BD_CrearActualizar(ByVal wp_sCmdSel As String) As Boolean
        ...
        Try
            Plo_Var_Frm()
            BD_eATALM_Var()
            wl_bYesNo = clnATALM.cnCrearActATALM(wl_eATALM,
                                                 wr_bEOFE1,
                                                 wp_sCmdSel)
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub BD_DatPrmTipTbl(ByRef wl_sTipTbl As String)
        Try
            wl_sNomTblE1 = "ATALM"
            wl_sNomCmpE11 = "sCodAlm"
            wl_sTipCmpE11 = "C"
            wl_sTitCmpE11 = "Código alm "
            wl_sDatCmpE11 = txtsCodAlm.Text
    ...
    Private Sub BD_eATALM_Var()
        Try
            With wl_eATALM
                ...
                '.sCtaWIP = vl_sCtaWIP
                .bSelxDef = vl_bSelxDef
                .bRegAci = vl_bRegAci
            End With

        Catch ex As Exception
            MsgBox(ex.Message)
            MsgBox("Error en el SUB: BD_eATALM_Var")
        End Try
    End Sub
    Private Sub BD_Var_eATALM()
        Try
            With wl_eATALM
                vl_sCodAlm = .sCodAlm
                vl_sNomAlm = .sNomAlm
                ...
                'vl_sCtaWIP = .sCtaWIP
                vl_bSelxDef = .bSelxDef
                vl_bRegAci = .bRegAci
            End With

        Catch ex As Exception
            MsgBox(ex.Message)
            MsgBox("Error en el SUB: BD_Var_eATALM")
        End Try
    End Sub
    Private Sub BD_eATALM_DT(ByVal wp_DTE1 As DataTable)
        Try
            ...
            moo_eATALM_DT(wl_eATALM,
                          wp_DTE1,
                         wl_nRow)
            wl_sDatCmpE12 = txtsCodAlm.Text

        Catch ex As Exception
            MsgBox("Error :  BD_eATALM_DT")
            MsgBox(ex.Message)
        End Try
    End Sub
#End Region
#Region "041 BD Procedimientos sobre la BD. Comunes"
    Private Sub BD_tsbPASU()
        Try
            ...
            vl_sCodAlm = wl_DTE1.Rows(0).Item("sCodAlm")
            wl_sDatCmpE11 = vl_sCodAlm
            BD_BuscarATALM()
            BD_Var_eATALM()
            Plo_Frm_Var()
            mof_ActivarOK(Me)
    ...
    Private Sub cmdCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCrear.Click
        Try
            ...
            If txtsCodAlm.Text <> "" Then
                vl_sCodAlm = txtsCodAlm.Text
                BD_DatPrmTipTbl(wl_sTipTbl)
                wr_bEOFE1 = mof_fConATALM(vl_sCodAlm,
                                          wl_eATALM)
                If wr_bEOFE1 Then
                    wl_bYesNo = BD_CrearActualizar(wp_sCmdSel)
                    If wl_bYesNo Then
            ...
            If txtsCodAlm.Text <> "" Then
                ...
                If wp_nResMsg = 6 Then
                    ...
                    If Not wr_bEOFE1 Then
                        BD_eATALM_DT(wl_DTE1)
                        wl_bVda = False
                        wp_sNomTbl = ""
                        wl_bYesNo = mov_VdasCodAlm(vl_sCodAlm,
                                                   wp_sNomTbl,
                                                   wl_bVda)
                        If wl_bVda = True Then
                            wl_bYesNo = clnATALM.cnEliATALM(wl_eATALM,
                                                            wr_bEOF)
                            If wl_bYesNo Then
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_IniciarVar()
        Try
            wl_bYesNo = False
            wl_sCodErrAdi = "10-303"
            wl_sCodErrCon = "10-103"
            wl_sCodErrOk = "20-001"
    ...
    Private Sub Plo_Frm_Var()
        Try
            ...
            txtsNomAlm.Text = vl_sNomAlm
            txtsUbiAlm.Text = vl_sUbiAlm
    ...
    Private Sub Plo_Var_Frm()
        Try
            ...
            vl_sCodAlm = txtsCodAlm.Text
            vl_sNomAlm = txtsNomAlm.Text
            vl_sUbiAlm = txtsUbiAlm.Text
...
#Region "081 Plo Procedimientos del Formulario. Comunes"
    ...
    Private Sub Plo_ActivarCmpAct()
        Try
            ...
            txtsNomAlm.Enabled = True
            txtsUbiAlm.Enabled = True
    ...
    Private Sub Plo_InactivarCmpAct()
        Try
            txtsCodAlm.Enabled = False
            txtsNomAlm.Enabled = False
            txtsUbiAlm.Enabled = False
...
#Region "082 Elo Eventos locales del Formulario"
    Private Sub txtsCodAlm_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtsCodAlm.KeyUp
        Try
...
#Region "110 grl Changed"
    ...
    Private Sub grl_Txt_Changed(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If DirectCast(sender, TextBox).Name = "txtsCodAlm" Then
            wl_sClaPpl = txtsCodAlm.Text
            mof_LmpMsgError()
        Else
            grl_TextChange()
        End If
    ...
    Private Sub grl_Txt_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If cmdCancelar.Focused = False Then
            If wl_cvTxt IsNot Nothing Then
                If wl_cvTxt.Name = "txtsCodAlm" Then
                    mov_VdaTxt(wl_bVda,
                               txtsCodAlm)
                End If
            End If
