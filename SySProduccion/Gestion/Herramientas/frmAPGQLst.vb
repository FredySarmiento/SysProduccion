...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    'Estructuras
    Public Property wp_eAPQDG As moe_Estructuras.eAPQDG
    'variables
...
#Region "015 Estructuras"
    ...
    Dim wl_aeAPGQLst() As moe_Estructuras.eAPGQLst
...
#Region "020 frm Eventos - Principal"
    Private Sub frmAPGQLst_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "043 BD Cargar"
    Private Sub BD_CargarAPQDG()
        Try

            Dim wl_frmLst As New frmAPQDG
            wl_eAPQDG = New moe_Estructuras.eAPQDG
            wl_frmLst.wp_eAPQDG = New moe_Estructuras.eAPQDG
            wl_nRow = wl_CtrlDgv.CurrentCellAddress.Y
            wl_nCol = wl_CtrlDgv.CurrentCellAddress.X

            wl_frmLst.vp_sCodStr = wl_CtrlDgv.CurrentRow.Cells("sCodStr").Value
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    ...
    Private Sub dgv_DetADgv()
        ...
        ReDim wl_aeAPGQLST(0)

        wl_sNomtbl = "APGQLst"
        wl_CtrlDgv = Me.dgv1
        wl_eAPGQLST = New moe_Estructuras.eAPGQLst

        wl_eAPGQLst.sCodStr = vp_sCodStr

        Try
            wl_DTL1 = clnConTbl.cndtCargarLista(wl_sNomtbl,
                                                wl_bEOF)
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_IniciarFrm()
        Try
            wl_bYesNo = False
            wl_bEdit = False
            wl_sNomFrm = "frmAPGQLst"
            wl_sNomTblE1 = "APGQLst"
            dgv_DetADgv()
            mof_ActivarOK(Me)
            cmdOk.Focus()
