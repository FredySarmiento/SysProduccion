...
#Region "020 frm Eventos - Principal"
    Private Sub frmAPQDG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "050 CommandButtons_Click ABRECO Controladores de Eventos (Remitente_evento)"
    Private Sub cmdActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdActualizar.Click
        Try
            ...
            If wl_bYesNo Then
                wl_bYesNo = dgv_ActDetAPQDG(wp_sCmdSel)
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    Private Function dgv_ActDetAPQDG(ByVal wp_sCmdSel As String) As Boolean
        Dim wl_nRow As Integer
        ...
        Try
            ...
            For wl_nRow = 0 To dgv1.RowCount - 1
                ...
                moo_eAPQDG_DGV(wl_eAPQDG,
                               Me.dgv1,
                               wl_nRow)
                '                  
                If wl_eAPQDG.nID <> 0 Then
                    wp_sCmdSel = "A"
                Else
                    wp_sCmdSel = "C"
                End If
                If dgv1.Rows(wl_nRow).Visible = True Then
                    wl_bYesNo = clnAPQDG.cnCrearActAPQDG(wl_eAPQDG,
                                                         wr_bEOFL1,
                                                         wp_sCmdSel)
                Else
                    If wp_sCmdSel = "A" Then
                        wl_bYesNo = clnAPQDG.cnEliAPQDG(wl_eAPQDG,
                                                        wr_bEOFL1)
                    End If
                End If
    ...
    Private Sub dgv_DetADgv()
        ...
        wl_CtrlDgv = Me.dgv1
        wl_eAPQDG = New moe_Estructuras.eAPQDG
        wl_eAPQDG.sCodStr = vp_sCodStr

        Try
            wl_DTL1 = clnAPQDG.cndtConAPQDG(wl_eAPQDG,
                                            wl_bEOF)
