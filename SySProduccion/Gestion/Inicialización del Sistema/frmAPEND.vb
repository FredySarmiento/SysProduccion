...
#Region "015 Estructuras"
    ...
    Dim wl_aeAPEND() As moe_Estructuras.eAPDGV
    Dim wl_aeAPLND1() As moe_Estructuras.eAPDGV
    Dim wl_aeAPQDG() As moe_Estructuras.eAPQDG
    Dim wl_eAPDGV As New moe_Estructuras.eAPDGV
    Dim wl_eAPQDG As New moe_Estructuras.eAPDGV
...
#Region "020 frm Eventos - Principal"
    Private Sub frmAPEND_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "043 BD Cargar"
    Private Sub BD_CargarAPLND1()
        Try
            ...
            wl_frmLst.vp_sCodDoc = wl_CtrlDgv.CurrentRow.Cells("sCodDoc").Value
            wl_frmLst.vp_sCodSer = wl_CtrlDgv.CurrentRow.Cells("sCodSer").Value
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    ...
    Private Sub dgv_DetADgv()
        ...
        wl_CtrlDgv = Me.dgv1
        Try
            wl_DTL1 = clnTblAB.cndtCrgAPEND(wl_bEOF)
