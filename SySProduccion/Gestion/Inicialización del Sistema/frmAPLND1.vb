...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    'Estructuras
    Public Property wp_eAPEND As moe_Estructuras.eAPEND
...
#Region "012 BD - Variables campos BD Locales"
    ...
    Dim vl_nNroIni As Long
    Dim vl_nNroSig As Long
    Dim vl_nNroFin As Long
...
#Region "014 Objetos locales"
    ...
    Dim clnAPEND As New ClaseNegocios.clnAPEND
...
#Region "020 frm Eventos - Principal"
    Private Sub frmAPLND1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "043 BD Cargar"
    Private Sub BD_CargarAPLND1(ByVal wl_CellCod As Integer,
                                ByVal wl_CellDes As Integer,
                                ByVal wl_CellSig As Integer)
        Try

            Dim wl_frmLst As New frmAPLND1
            wl_eAPLND1 = New moe_Estructuras.eAPLND1
            wl_frmLst.wp_eAPEND = New moe_Estructuras.eAPEND
            wl_frmLst.ShowDialog()
            wl_nRowAct = wl_CtrlDgv.CurrentCellAddress.Y
            If wl_frmLst.wp_eAPEND.sCodDoc <> "" Then
...
#Region "050 CommandButtons_Click ABRECO Controladores de Eventos (Remitente_evento)"
    ...
    Private Sub cmdActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdActualizar.Click
        Try
            ...
            If wl_bYesNo Then
                wl_bYesNo = dgv_ActDetAPLND1(wp_sCmdSel)
...
#Region "070 DGV Procedimientos del Usuario. Personalizados"
    Private Function dgv_ActDetAPLND1(ByVal wp_sCmdSel As String) As Boolean
        Dim wl_nRow As Integer
        ...
        Try
            ...
            For wl_nRow = 0 To dgv1.RowCount - 1
                ...
                moo_eAPLND1_DGV(wl_eAPLND1,
                                ...
                                wl_nRow)
                '                  
                If wl_eAPLND1.nID <> 0 Then
                    wp_sCmdSel = "A"
                Else
                    wp_sCmdSel = "C"
                End If
                If dgv1.Rows(wl_nRow).Visible = True Then
                    wl_bYesNo = clnAPLND1.cnCrearActualizar(wl_eAPLND1,
                                                            wr_bEOFL1,
                                                            wp_sCmdSel)
                    wl_eAPEND = New moe_Estructuras.eAPEND
                    wl_eAPEND.sCodDoc = wl_eAPLND1.sCodDoc
                    wl_eAPEND.sCodSer = wl_eAPLND1.sCodSer
                    wl_eAPEND.nNroIni = wl_eAPLND1.nNroIni
                    wl_eAPEND.nNroFin = wl_eAPLND1.nNroFin
                    wl_eAPEND.nNroSig = wl_eAPLND1.nNroSig

                    wl_bYesNo = clnAPEND.cnCrearActualizar(wl_eAPEND,
                                                            wr_bEOFL1,
                                                            wp_sCmdSel)

                Else
                    If wp_sCmdSel = "A" Then
                        wl_bYesNo = clnAPLND1.cnEliminar(wl_eAPLND1,
                                                         wr_bEOFL1)
                    End If
                End If
    ...
    Private Sub dgv_AdiRow()
        ...
        Try
            ...
            With wl_CtrlDgv
                ...
                .CurrentRow.Cells("sCodDoc").Value = vp_sCodDoc
                .CurrentRow.Cells("sCodSer").Value = vp_sCodSer
            End With
            wl_nTab = 0
    ...
    Private Sub dgv_DetADgv()
        ...
        Try
            wl_DTL1 = clnAPLND1.cndtConAPLND1(wl_eAPLND1,
                                              wl_bEOF)
