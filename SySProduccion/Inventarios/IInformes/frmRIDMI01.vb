...
#Region "020 frm Eventos - Principal"
    Private Sub frmRIDMI01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "090 Rpt - Reportes"
    Private Sub Rpt_PrmRpt()
        Try
            ...
            wl_bSDM_EDM = False
            If wl_aeIELDMI1(0).eIEDMI.sCodItm <> "" Then
                Dim wl_frmRPT01 As New rptRIDMI01
