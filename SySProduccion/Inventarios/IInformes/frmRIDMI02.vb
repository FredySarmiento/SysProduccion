...
#Region "020 frm Eventos - Principal"
    Private Sub frmRIDMI02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "CommandButtons_Click ABRECO Controladores de Eventos (Remitente_evento)"
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        Try
            wp_sCmdSel = "O"
            Plo_VdaVar()
            BD_frmIELDMI1_QIniFin()
            If Not IsNothing(wl_aeIELDMI1) Then
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    Private Sub cmdIEDMI_QAlmFin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdIEDMI_QAlmFin.Click
        Try
        ...
        End Try
    End Sub
    Private Sub cmdIEDMI_QAlmIni_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdIEDMI_QAlmIni.Click
        Try
    ...
    Private Sub Plo_VdaVar()
        Try
            ...
            If txtsCodAlmFin.Text = "" Then
                ...
                wl_eIEDMI_Fin.sCodAlm = txtsCodAlmFin.Text
            End If
            If txtsCodAlmIni.Text = "" Then
                txtsCodAlmIni.Text = txtsCodAlmFin.Text
                wl_eIEDMI_Ini.sCodAlm = txtsCodAlmIni.Text
            End If
...
#Region "090 Rpt - Reportes"
    Private Sub Rpt_PrmRpt()
        Try
            ...
            ReDim wl_aeIELDMI1_Rpt(0)
            Dim wl_bSDM_EDM As Boolean
            wl_bSDM_EDM = False
            If wl_aeIELDMI1(0).eIEDMI.sCodItm <> "" Then
                Dim wl_frmRPT01 As New rptRIDMI02
                moo_aeIELDMI1Rpt_aeIELDMI1(wl_aeIELDMI1_Rpt,
                                           wl_aeIELDMI1)
                wl_frmRPT01.wp_aeIELDMI1_Rpt = wl_aeIELDMI1_Rpt
                wl_frmRPT01.Show()
            End If
        Catch ex As Exception
