...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    Public Property wp_aeGELMOV1 As Array
...
#End Region
#End Region
    Private Sub rptIRMOV03_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("GELMOV1", wp_aeGELMOV1))
