...
#End Region
#End Region
    Private Sub rptRIDMI02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("IELDMI1_Rpt", wp_aeIELDMI1_Rpt))
