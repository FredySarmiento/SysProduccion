...
#End Region
#End Region
    Private Sub rptRIDMI03_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("IEDMI", wp_aeIEDMI))
