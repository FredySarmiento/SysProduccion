...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    Public Property wp_aeKARDEX As Array
...
#End Region
#End Region
    Private Sub rptRIMOV01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("KARDEX", wp_aeKARDEX))
