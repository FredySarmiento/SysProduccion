Public Class frmIEENI_LeeENT
    Public wp_sCodDocOri As String
    Public wp_nNroDocOri As Long
    Private Sub frmIEENI_LeeENT_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            '           Me.Text += "  -  " + vg_sNomCia
        ...
        Catch ex As Exception
            MsgBox("Error :  frmIEENI_LeeENT_Load")
            MsgBox(ex.Message)
        End Try
    End Sub
