...
#Region "020 frm Eventos - Principal"
    Private Sub frmIESAI_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        ...
        End Try
    End Sub
    Private Sub frmIESAI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    Private Sub cmdCpd_Click(sender As System.Object, e As System.EventArgs) Handles cmdCpd.Click
        Try
            Dim wl_frmIESAI_LeeSAL As New frmIESAI_LeeSAL


            wl_frmIESAI_LeeSAL.wp_sCodDocOri = vl_sCodDoc
            wl_frmIESAI_LeeSAL.wp_nNroDocOri = 0
            wl_sCodDocIni = vl_sCodDoc
            wl_nNroDocIni = CInt(txtnNroDoc.Text)
            vl_nNroDoc = CInt(txtnNroDoc.Text)
            wl_nNroDocOri = 0

            wl_frmIESAI_LeeSAL.ShowDialog()
            wl_nNroDocOri = CInt(wl_frmIESAI_LeeSAL.wp_nNroDocOri)
    ...
    Private Sub cmdLstIESAI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLstIESAI.Click
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "IESAI"
            wl_eGEMOV = New moe_Estructuras.eGEMOV
            ...
            End If
        Catch ex As Exception
            MsgBox("Error : cmdLstIESAI_Click")
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub Rpt_PrmRpt()
         Try
            ...
            wl_sNroALetras = mof_NroALetras(CType(wl_eGEMOV.nTotDoc, String),
                                            wl_eGEMOV.sCodMon)
            mof_ActivarOK(Me)
            Dim wl_frmRPT As New rptIRSAI01
