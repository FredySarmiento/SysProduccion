...
#Region "011 frm - Variables Locales"
    ...
    Public Property wp_aeATTIN As Array
...
#Region "020 - Principal"
    Private Sub rptATTINForm1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("ATTIN", wp_aeATTIN))
        ...
        Catch ex As Exception
            MsgBox("Error :  rptATTINForm1_Load")
            MsgBox(ex.Message)
        End Try
    End Sub
#End Region
