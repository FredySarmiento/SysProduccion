...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    Public Property wp_bSelItm As Boolean
...
#Region "010 Inicia. vl - wl Definición del variables Locales"
    ...
    Dim wl_PrmRptSelItm As ReportParameter() = New ReportParameter(0) {}

#End Region
#End Region
#Region "020 frm Eventos - Principal"
    Private Sub rptPROP006_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            wl_PrmRptSelItm(0) = New ReportParameter("RptPrmSelItm", wp_bSelItm)
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("DataSet1", wp_aePEODP))
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("DataSet2", wp_aePLODP1))
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("DataSet3", wp_aePLODP2))
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("DataSet4", wp_aePLODP3))
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("DataSet5", wp_aePLODP4))
            ...
            RptVwr.LocalReport.SetParameters(wl_PrmRptSelItm)
