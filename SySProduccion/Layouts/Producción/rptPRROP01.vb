...
#Region "001 Inicia. wg - vg Definición del variables públicas"
    ...
    Public Property wp_aePEROP As Array
    Public Property wp_aePLROP1 As Array
...
#Region "020 frm Eventos - Principal"
    Private Sub rptPRROP01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("PEROP", wp_aePEROP))
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("PLROP1", wp_aePLROP1))
