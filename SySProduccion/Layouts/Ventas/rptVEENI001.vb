...
#End Region
    Private Sub rptVEENI001_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            RptVwr.LocalReport.DataSources.Add(New ReportDataSource("TLDMT4", wp_aeTLDMT4))
