...
#Region "wp variables APDGV "
    ...
    Public wp_nColNroBas As Integer
...
#Region "Estructuras"
    ...
    Public wg_eAPDGV As New clpEstructuras.eAPDGV
    Public wg_aeAPDGV() As clpEstructuras.eAPDGV

    Public wg_eAPQDG As New clpEstructuras.eAPQDG
    Public wg_aeAPQDG() As clpEstructuras.eAPQDG

    Public wg_eATCCO As New clpEstructuras.eATCCO
    Public wg_aeATCCO() As clpEstructuras.eATCCO

    Public wg_eATIVA As New clpEstructuras.eATIVA
    Public wg_aeATIVA() As clpEstructuras.eATIVA

    Public wg_eATVEN As New clpEstructuras.eATVEN
    Public wg_aeATVEN() As clpEstructuras.eATVEN

    Public wg_eFTPUC As New clpEstructuras.eFTPUC
    Public wg_aeFTPUC() As clpEstructuras.eFTPUC

    Public wg_eIEDMI As New clpEstructuras.eIEDMI
    Public wg_aeIEDMI() As clpEstructuras.eIEDMI

    Public wg_eGEMOV As New clpEstructuras.eGEMOV
    Public wg_aeGEMOV() As clpEstructuras.eGEMOV

    Public wg_eGLMOV1 As New clpEstructuras.eGLMOV1
    Public wg_aeGLMOV1() As clpEstructuras.eGLMOV1

    Public wg_ePEODP As New clpEstructuras.ePEODP
    Public wg_aePEODP() As clpEstructuras.ePEODP

    Public wg_ePLODP1 As New clpEstructuras.ePLODP1
    Public wg_aePLODP1() As clpEstructuras.ePLODP1

    Public wg_eSdoAlm As New clpEstructuras.eSdoAlm
    Public wg_aeSdoAlm() As clpEstructuras.eSdoAlm

    Public wg_eIELDMI1 As New clpEstructuras.eIELDMI1
    Public wg_aeIELDMI1() As clpEstructuras.eIELDMI1

    Public wg_eITALM As New clpEstructuras.eITALM
    Public wg_aeITALM() As clpEstructuras.eITALM

    Public wg_eTEDMT As New clpEstructuras.eTEDMT
    Public wg_aeTEDMT() As clpEstructuras.eTEDMT


    Public wl_eATCCO As New clpEstructuras.eATCCO
    Public wl_aeATCCO() As clpEstructuras.eATCCO

    Public wl_eATIVA As New clpEstructuras.eATIVA
    Public wl_aeATIVA() As clpEstructuras.eATIVA

    Public wl_eATVEN As New clpEstructuras.eATVEN
    Public wl_aeATVEN() As clpEstructuras.eATVEN

    Public wl_eFTPUC As New clpEstructuras.eFTPUC
    Public wl_aeFTPUC() As clpEstructuras.eFTPUC

    Public wl_eITALM As New clpEstructuras.eITALM
    Public wl_aeITALM() As clpEstructuras.eITALM

    Public wl_eIEDMI As New clpEstructuras.eIEDMI
    Public wl_aeIEDMI() As clpEstructuras.eIEDMI

    Public wl_eIELDMI1 As New clpEstructuras.eIELDMI1
    Public wl_aeIELDMI1() As clpEstructuras.eIELDMI1


    Public wl_eGEMOV As New clpEstructuras.eGEMOV
    Public wl_aeGEMOV() As clpEstructuras.eGEMOV

    Public wl_eGLMOV1 As New clpEstructuras.eGLMOV1
    Public wl_aeGLMOV1() As clpEstructuras.eGLMOV1

    Public wl_ePEODP As New clpEstructuras.ePEODP
    Public wl_aePEODP() As clpEstructuras.ePEODP

    Public wl_ePLODP1 As New clpEstructuras.ePLODP1
    Public wl_aePLODP1() As clpEstructuras.ePLODP1

    Public wl_eTEDMT As New clpEstructuras.eTEDMT
    Public wl_aeTEDMT() As clpEstructuras.eTEDMT
