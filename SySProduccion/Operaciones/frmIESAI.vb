...
#Region "frm Eventos - Principal"
    ...
    Private Sub frmISINV_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        grl_RemoveHandler()
    End Sub

    Private Sub frmISINV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grl_RemoveHandler()
        grl_AddHandler()
        mof_IniciarVar()
        Plo_IniciarVar()
