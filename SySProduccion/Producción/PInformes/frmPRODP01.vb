...
#Region "020 frm Eventos - Principal"
    Private Sub frmRPODP01_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            Me.Dispose()
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_IniciarVar()
        Try
            ...
            chbbImpRP001.Checked = True
            chbbImpRP002.Checked = False
            chbbImpRP003.Checked = False
            chbbImpRP004.Checked = False
    ...
    Private Sub Rpt_PrmRpt()
        Try
            ...
            For wl_i = 0 To wl_aePEODP.Count - 1
                ...
                If chbbImpRP001.Checked = True Then
                ...
                If chbbImpRP002.Checked = True Then
                ...
                If chbbImpRP003.Checked = True Then
                ...
                If chbbImpRP004.Checked = True Then
