...
#Region "020 frm Eventos - Principal"
    Private Sub frmPRODP03_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            mof_fCnfCtrl(Me)
            mof_IniciarVar()
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    ...
    Private Sub cmdPEODPFin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPEODPFin.Click
        Try
            wl_ePEROP = wl_ePEROP_Fin
            wl_ePEROP.nNroDocBas = -1
            vl_sCodStr = "EPEROP_QNRODOCDOC"
            wl_sMayMenIgu = "Men"
            BD_frmPEROP_QGrl()
            If wl_ePEROP_Grl.nNroDocBas <> 0 Then
                txtnNroDocBasFin.Text = wl_ePEROP_Grl.nNroDocBas
                vl_nNroDocBas = wl_ePEROP_Grl.nNroDocBas
                wl_ePEROP_Fin.nNroDocBas = wl_ePEROP_Grl.nNroDocBas
                wl_ePEROP.nNroDocBas = wl_ePEROP_Grl.nNroDocBas
                ' cmdABESDIni.Focus()
            End If
        Catch ex As Exception
            MsgBox("Error : cmdIEMOVFin_Click")
        ...
        End Try
    End Sub
    Private Sub cmdPEODPIni_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPEODPIni.Click
        Try
            wl_ePLROP1 = wl_ePLROP1_Ini
            wl_ePLROP1.nNroDocBas = -1
            vl_sCodStr = "EPLROP1_QNRODOCBAS"
            wl_sMayMenIgu = "May"
            BD_frmPLROP1_QGrl()
            If wl_ePLROP1_Grl.nNroDocBas <> 0 Then
                txtnNroDocBasIni.Text = wl_ePLROP1_Grl.nNroDocBas
                vl_nNroDocBas = wl_ePLROP1_Grl.nNroDocBas
                wl_ePLROP1_Ini.nNroDocBas = wl_ePLROP1_Grl.nNroDocBas
                wl_ePLROP1.nNroDocBas = wl_ePLROP1_Grl.nNroDocBas
                cmdPEODPFin.Focus()
            End If

        Catch ex As Exception
            MsgBox("Error : cmdPEODPIni_Click_1")
            MsgBox(ex.Message)
        End Try
    End Sub
...
#Region "080 Plo Procedimientos del Formulario. Personalizados"
    ...
    Private Sub Plo_VdaVar()
        Try
            ...
            If Val(txtnNroDocBasIni.Text) = 0 Then
                txtnNroDocBasIni.Text = txtnNroDocBasFin.Text
            End If
            If Val(txtnNroDocBasFin.Text) = 0 Then
                txtnNroDocBasFin.Text = txtnNroDocBasIni.Text
            End If
            ...
            wl_ePEROP_Ini.nNroDocBas = Val(txtnNroDocBasIni.Text)
            wl_ePEROP_Fin.nNroDocBas = Val(txtnNroDocBasFin.Text)
...
#Region "090 Rpt - Reportes"
    Private Sub Rpt_PrmRpt()
        Try
            ...
            If wl_aePELROP1(0).sCodDoc <> "" Then
                Dim wl_frmRPT02 As New rptPRODP031
                wl_frmRPT02.wp_aePELROP1 = wl_aePELROP1
                wl_frmRPT02.Show()
                Dim wl_frmRPT03 As New rptPRODP032
                wl_frmRPT03.wp_aePELROP1 = wl_aePELROP1
                wl_frmRPT03.Show()
