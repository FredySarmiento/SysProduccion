...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmPEEDM_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        Catch ex As Exception
            MsgBox("Error :  frmPEEDM_Disposed")
            MsgBox(ex.Message)
        End Try
    End Sub


    Private Sub frmPEEDM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    ...
    Private Sub cmdLstPEEDM_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLstPEEDM.Click
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = "PEEDM"
            wl_eGEMOV = New moe_Estructuras.eGEMOV
                ...
                For wl_nRow = 0 To wl_nRowDgv
                    ...
                    If .Rows(wl_nRow).Cells("bIndCan").Value = True Then
                        If .Rows(wl_nRow).Cells("nCanItm").Value > .Rows(wl_nRow).Cells("nSdoAlm").Value Then
                            '   wl_CtrlDgv.Rows(wl_nRow).DefaultCellStyle.BackColor = Color.Red
                            'wl_CtrlDgv.Rows(wl_nRow).DefaultCellStyle.BackColor = Color.Red
    ...
    Private Sub Rpt_PrmRpt()
        ...
        Try
            ...
            wl_sNroALetras = mof_NroALetras(CType(wl_eGEMOV.nTotDoc, String),
                                            wl_eGEMOV.sCodMon)
            mof_ActivarOK(Me)
            Dim wl_frmRPT As New rptPREDM01
