...
#Region "020 frm Eventos - Principal"
    ...
    Private Sub frmPESDP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
    ...
    Private Sub Rpt_PrmRpt()
        ...
        Try
            ...
            wl_sNroALetras = mof_NroALetras(CType(wl_eGEMOV.nTotDoc, String),
                                            wl_eGEMOV.sCodMon)
            mof_ActivarOK(Me)
            Dim wl_frmRPT As New rptPRSDP01
