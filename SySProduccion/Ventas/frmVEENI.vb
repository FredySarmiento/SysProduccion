...
#Region "020 frm Eventos - Principal"
    Private Sub frmVEENI_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        Catch ex As Exception
            MsgBox("Error :  frmVEENI_Disposed")
            MsgBox(ex.Message)
        End Try

    End Sub

    Private Sub frmVEENI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
        ...
        Try
            ...
            Else
                If vl_sEstPdo = "2" Then
                    MsgBox("Período Contable, para la fecha contable, Está Cerrado")
                    dtpFecCtb.Focus()
                    Return wl_bYesNo
                End If
            End If
...
#Region "060 CommandButtons_Click Lista Controladores de Eventos (Remitente_evento)"
    ...
    Private Sub cmdLinea_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles cmdLinea.Click
        ...
        wl_frmLst.ShowDialog()
    End Sub
    Private Sub cmdLstVEENI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLstVEENI.Click
        Try
            BD_CargarVEENI()

        Catch ex As Exception
            MsgBox(ex.Message)
            MsgBox("Error en el SUB: cmdLstVEENI_Click")
        End Try
    End Sub
...
#Region "090 Rpt - Reportes"
    Private Sub Rpt_PrmRpt()
        Try
            ...
            Dim wl_frmRPT As New rptVEENI001
