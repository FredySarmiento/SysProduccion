...
#Region "020 frm Eventos - Principal"
    Private Sub frmVEFAC_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        Catch ex As Exception
            MsgBox("Error :  frmVEFAC_Disposed")
            MsgBox(ex.Message)
        End Try
    End Sub
    Private Sub frmVEFAC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
