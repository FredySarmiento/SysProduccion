...
#Region "020 frm Eventos - Principal"
    Private Sub frmVENOC_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            grl_RemoveHandler()
            Me.Dispose()
        Catch ex As Exception
            MsgBox("Error :  frmVENOC_Disposed")
            MsgBox(ex.Message)
        End Try

    End Sub

    Private Sub frmVENOC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Text += "  -  " + vg_sNomCia
            grl_RemoveHandler()
            grl_AddHandler()
...
#Region "082 Pep PROCEDIMIENTOS EVENTOS PERSONALIZADOS"
    Private Sub txtnNroDoc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtnNroDoc.DoubleClick
        Try
            Dim wl_frmLst As New frmGQLst
            wg_sTblCon1 = wl_sNomTblE1
            wl_frmLst.wp_sTxtFrm = "Consulta consecutivo " & Me.Name
            wl_frmLst.ShowDialog()
